...
enum class IntKey(
    ...
    MealUpfrontPercentageHeavy("meal_upfront_percentage_heavy", 60, 10, 100),
    MealFatIntensityRefG("meal_fat_intensity_ref_g", 40, 10, 200),
    MealProteinIntensityRefG("meal_protein_intensity_ref_g", 80, 20, 400),
    MealMinFatG("meal_min_fat_g", 5, 0, 50),
    MealMinProteinG("meal_min_protein_g", 10, 0, 100),
